...
class DetectionModel(paddle.nn.Layer):
    def __init__(self):
        ...
        self.x635 = self.create_parameter(dtype='float32', shape=(1, 1344), default_initializer=paddle.nn.initializer.Constant(value=0.0))
        ...
        self.x854 = self.create_parameter(dtype='float32', shape=(1, 2, 1344), default_initializer=paddle.nn.initializer.Constant(value=0.0))
    ...
    def forward(self, x0):
        ...
        x839, x840 = x838
        x843 = paddle.reshape(x=x839, shape=[1, 4, 16, 1344])
        ...
        x853 = paddle.reshape(x=x851, shape=[1, 4, 1344])
        x854 = self.x854
...
def main(x0):
    ...
    params = paddle.load(r'/home/gabeo/Code/SE4442/SE4442-Group-Project/training/imgsz256/runs/detect/train/weights/best_paddle_model/model.pdparams')
